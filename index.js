...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: The nested function can acess the variable internal because since the variable is within the myFunction, it is within the scope that nestedFunction can reach and acess it.
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    ...
    array.forEach((name)=>{ displayNames.push(`name: ${name.animal_name}, scientific: ${name.scientific_name}`) 
    })
    return displayNames
  }
 ...
 function USApop(array){
  let totalpop = array.reduce( function(total, name){
    return total + name.population;
  }, 0)
  return totalpop
}
